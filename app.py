...
# Footer
    st.markdown("<br><p style='text-align:center; font-size:14px; color:gray;'>Developed by Kavya Gowda 🚀</p>", unsafe_allow_html=True)
...
elif st.button("❌ Close Chatbot"):
    st.session_state['conversation'] = []
    st.write("Chatbot closed. Click 'Open Chatbot' to start again.")
...
st.markdown("""
    ...
    <footer style="text-align: center; padding: 10px; font-size: 14px;">
        ...
        <p>Designed and Developed by Kavya Gowda</p>
        <p>Contact: <a href="mailto:kavya@example.com">kavya@example.com</a> |  
